...
def setrun(claw_pkg='geoclaw'):
    ...
    rundata.gaugedata.gauges.append([1, -87.22, 30.40,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
    # Panama City Beach, FL, 8729210
    rundata.gaugedata.gauges.append([2, -85.88, 30.22,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
    # Apalachicola, FL, 8728690
    rundata.gaugedata.gauges.append([3, -84.98, 29.73,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
...
def setgeo(rundata):
    ...
    clawutil.data.get_remote_file(  "http://hurricanes.ral.ucar.edu/repository/data/bdecks_open/2018/bal142018.dat")
    ...
    # Uncomment/comment out to use the old version of the michael storm file
    # michael = Storm(path="old_michael.storm", file_format="ATCF")
    michael = Storm(path=atcf_path, file_format="ATCF")

    # Calculate landfall time - Need to specify as the file above does not
    # include this info (10/10/2018 ~ 18 UTC (17:30))
    michael.time_offset = datetime.datetime(2018, 10, 10, 18)
